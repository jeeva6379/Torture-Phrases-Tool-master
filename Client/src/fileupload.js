...
const FileUpload = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://deploy-tortured-phrases-web-api.vercel.app/api/upload", formData);
      ...
      console.log(responseHighlightedText);
